    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-24 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div className="px-4 py-8 sm:p-10">
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Email Settings</h1>
              ...
              <Dialog open={isEmailDialogOpen} onOpenChange={setIsEmailDialogOpen}>
                ...
                <DialogContent>
                  ...
                  <form onSubmit={handleEmailChange} className="space-y-4">
                    ...
                    <DialogFooter>
                      <Button type="submit" className="bg-blue-950 hover:bg-blue-900">Confirm Change</Button>
                    </DialogFooter>
                  </form>
                </DialogContent>
              </Dialog>
